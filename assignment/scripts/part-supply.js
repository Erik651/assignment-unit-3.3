...
if (supplyChanges[i] === 0 ) {zeroes.push(supplyChanges[i])}

else if (supplyChanges[i] >= 0) {positives.push(supplyChanges[i])}
...
if (supplyChanges[i] >= 1 ) {stretchPositives.push(supplyChanges[i])}

else if

  (supplyChanges[i] <= 0)  {stretchNegatives.push(supplyChanges[i])}



 (supplyChanges[i] === 0); {stretchZeroes.push(supplyChanges[i])}
